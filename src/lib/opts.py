...
# Code referenced from https://github.com/xingyizhou/CenterTrack/blob/master/src/lib/opts.py
class opts(object):
    def __init__(self):
        self.parser = argparse.ArgumentParser()
        # basic experiment setting
        self.parser.add_argument(
            "task", default="", help=" ddd  " "| tracking or combined with ,"
        )
        self.parser.add_argument(
            "--dataset",
            default="pixset",
        ...
        self.parser.add_argument(
            "--test_dataset", default="", help="nuscenes | mot | kitti_tracking"
        )
        ...
        self.parser.add_argument("--use_subset",  action="store_true")
        self.parser.add_argument("--sensor_dropout", type=float, default=0.1, help="probability of dropping cameras or pixell waveforms.")
        ...
        self.parser.add_argument(
            "--trainval",
            action="store_true",
            help="True to test on the validation set , False to test on the test set",
        )
        ...
        self.parser.add_argument("--max_frame_dist", type=int, default=1)
        ...
        self.parser.add_argument("--AFE", type=bool, default=True)
        self.parser.add_argument("--max_frame_dist_AFE", type=int, default=10)
        self.parser.add_argument("--max_object", type=int, default=100)
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--matching_weight", type=float, default=1, help="loss weight for depth."
        )
    ...
    def parse(self, args=""):
        ...
        if opt.resume and opt.load_model == "":
            ...
            opt.load_model_traj = os.path.join(opt.save_dir, "model_last.pth")
        return opt
